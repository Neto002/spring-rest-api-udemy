package com.neto.curso.configs;
...
public class TestConfigs {
    ...
    public static final String ORIGIN_LOCAL3000 = "http://localhost:3000";
    public static final String ORIGIN_LOCAL8081 = "http://localhost:8081";
}
